...
namespace FirstFloor.ModernUI.App.Common.Controls.TagControl
{
    ...
    public class TagControl : ListBox
    {
        ...
        // AllTags
        public List<Tag> AllTags { get { return (List<Tag>)GetValue(AllTagsProperty); } set { SetValue(AllTagsProperty, value); } }
        public static readonly DependencyProperty AllTagsProperty = DependencyProperty.Register("AllTags", typeof(List<Tag>), typeof(TagControl), new PropertyMetadata(new List<Tag>()));
